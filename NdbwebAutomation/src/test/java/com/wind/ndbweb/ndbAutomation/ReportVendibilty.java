...
public class ReportVendibilty extends AbstractTestNGSpringContextTests{
	...
	public void verifyReportVendibilty(Hashtable<String, String> data) {

		if (!DataReader.isTestCaseExecutable("ReportVendibilty", testExecutor.getXlsReader()))
		...
		testExecutor.executeKeywords("ReportVendibilty", data);
	...
	public Object[][] getVerifyReport() {
		return DataReader.getData("ReportVendibilty", testExecutor.getXlsReader());
	}
